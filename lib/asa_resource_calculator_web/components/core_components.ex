defmodule AsaResourceCalculatorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AsaResourceCalculatorWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AsaResourceCalculatorWeb.Gettext, "errors", msg, opts)
    # end
